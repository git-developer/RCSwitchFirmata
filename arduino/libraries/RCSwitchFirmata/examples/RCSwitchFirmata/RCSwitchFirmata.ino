...
/*
 ...
 This is an example use of RCSwitchFirmata. The easiest way to create a configuration is to
 ...
 *
 * By default Firmata uses the Serial-port (over USB) of the Arduino. RCSwitchFirmata may also
 ...
 * act as a server in order to establish a connection between RCSwitchFirmata and the
 * Firmata host application (your application).
 *
 * To use RCSwitchFirmata with Ethernet you will need to have one of the following
 * boards or shields:
 *
 ...
 *
 * To configure RCSwitchFirmata to use the an Arduino Ethernet Shield or Arduino Ethernet
...
#endif
#endif
  /* systemResetCallback is declared here (in RCSwitchFirmata.ino) */
